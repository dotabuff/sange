...
const (
	...
	EDOTAGCMsg_k_EMsgGCPassportVote                            EDOTAGCMsg = 7253
	...
	EDOTAGCMsg_k_EMsgGCPassportVoteSelection                   EDOTAGCMsg = 7257
	...
	EDOTAGCMsg_k_EMsgGCToGCGrantEventReward                    EDOTAGCMsg = 7389
...
var EDOTAGCMsg_name = map[int32]string{
	...
	7389: "k_EMsgGCToGCGrantEventReward",
...
const (
	...
	CSODOTALobby_COMPETITIVE_TEAM_MATCH  CSODOTALobby_LobbyType = 5
	CSODOTALobby_LEGACY_SOLO_QUEUE_MATCH CSODOTALobby_LobbyType = 6
	CSODOTALobby_COMPETITIVE_MATCH       CSODOTALobby_LobbyType = 7
	CSODOTALobby_COMPETITIVE_1V1_MATCH   CSODOTALobby_LobbyType = 8
)
...
var CSODOTALobby_LobbyType_name = map[int32]string{
	...
	2:  "TOURNAMENT",
	4:  "COOP_BOT_MATCH",
	5:  "COMPETITIVE_TEAM_MATCH",
	6:  "LEGACY_SOLO_QUEUE_MATCH",
	7:  "COMPETITIVE_MATCH",
	8:  "COMPETITIVE_1V1_MATCH",
}
var CSODOTALobby_LobbyType_value = map[string]int32{
	...
	"TOURNAMENT":              2,
	"COOP_BOT_MATCH":          4,
	"COMPETITIVE_TEAM_MATCH":  5,
	"LEGACY_SOLO_QUEUE_MATCH": 6,
	"COMPETITIVE_MATCH":       7,
	"COMPETITIVE_1V1_MATCH":   8,
}
...
type CDOTALobbyMemberPrivate struct {
	...
	ReadyState       *DOTALobbyReadyState `protobuf:"varint,2,opt,name=ready_state,enum=dota.DOTALobbyReadyState,def=0" json:"ready_state,omitempty"`
...
type CCompendiumTimestampedData struct {
	...
	ItemPurchases    []string `protobuf:"bytes,6,rep,name=item_purchases" json:"item_purchases,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}
...
func (m *CCompendiumTimestampedData) GetItemPurchases() []string {
	if m != nil {
