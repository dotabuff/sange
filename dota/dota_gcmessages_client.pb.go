...
const (
	...
	CMsgDOTAPopup_COMPETITIVE_MM_1V1_NO_PARTIES                         CMsgDOTAPopup_PopupID = 45
)
...
var CMsgDOTAPopup_PopupID_name = map[int32]string{
	...
	45: "COMPETITIVE_MM_1V1_NO_PARTIES",
}
var CMsgDOTAPopup_PopupID_value = map[string]int32{
	...
	"COMPETITIVE_MM_1V1_NO_PARTIES":                         45,
}
...
type CMsgDOTATournament_Team struct {
	...
	State            *ETournamentTeamState `protobuf:"varint,8,opt,name=state,enum=dota.ETournamentTeamState,def=0" json:"state,omitempty"`
	XXX_unrecognized []byte                `json:"-"`
}
